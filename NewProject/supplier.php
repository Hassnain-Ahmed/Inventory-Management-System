...
<body>
            ...
            <div id="pm_data">
                ...
                <div id="pm_d_left">
                    <form action="" method="POST"> <br>
                        ...
                        <span>Supplier Name</span><input type="text" placeholder="John Deo" name="s_name" required> <br>
                        <span>Supplier Address</span><input type="text" placeholder="Bristol Near Xyz Street" name="s_addr"> <br>
                        <span>Supplier Phone</span><input type="tel" placeholder="xx-xxx-xxx-xxx" name="s_phone"><br>
                        <span>Supplier Email</span><input type="email" placeholder="suppliername@email.com" name="s_email"><br>
                        <span>Company Name</span><input type="text" placeholder="Basmati | Other" name="s_companyname"><br> 
                        <span>Company Contact</span><input type="tel" placeholder="xx-xxx-xxx-xxx" name="s_companycontact"><br> 
    ...
    if(isset($_POST['sub']))
    {
        ...
        $query = mysqli_query($con, "insert into supplier(s_id, s_name, s_phone, s_addr, s_email, s_companyname, s_companycontact) values('', '$s_name', '$s_phone', '$s_addr', '$s_email', '$s_companyname', '$s_companycontact')");
        if($query)
        {
